...
function search_form( $form ) {
	$form = '<form class="searchform" role="search" method="get" action="' . home_url( '/' ) . '" > <input type="search" value="' . get_search_query() . '" name="s" id="s" placeholder="Tìm Kiếm" /><button class="btn-search" type="submit" href="javascript:void(0);"><i class="fas fa-search"></i></button></form>';
	return $form;
	}
